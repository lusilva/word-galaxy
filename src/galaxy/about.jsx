  ...
  x.render = function() {
    ...
    return (
      <div className='label about'>
        <a className='reset-color' onClick={toggleOpen}>About...</a>
        <Modal
          isOpen={isOpen}
        ...
        >
          <h1 style={{color: 'black'}}>About Word Galaxy</h1>
          <p>
          ...
          <h3>Goal</h3>
          <p>
            The goal of the project is to visually show the relationship between words, allowing you to naviate the word
          ...
          <p>
            Take "wheat" and "grain", for example. You can see a link going from "wheat" pointing towards "grain" which
            means that wheat "is a kind of" grain. Here, "wheat" is a hyponym and "grain" is a hypernym. In the case of
            verbs this same link can be understood better by "is one way to". So, for example, to trot "is one way to"
            walk.
          </p>
          <h4>How does search work?</h4>
          <p>
            When a search is made, a synset's synonyms are searched to match the query. This was done so that search may
